    ...
    return (
      <div>
        <Router>
          <NavBar />
          <Routes>
            <Route exact path="/" element={<News key='general' pageSize={this.pgSize} country='in' category='general' />} />
            <Route exact path="/business" element={<News key='business' pageSize={this.pgSize} country='in' category='business' />} />
            <Route exact path="/entertainment" element={<News key='entertainment' pageSize={this.pgSize} country='in' category='entertainment' />} />
            <Route exact path="/general" element={<News key='general' pageSize={this.pgSize} country='in' category='general' />} />
